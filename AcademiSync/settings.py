"""
Django settings for AcademiSync project.
...
SECRET_KEY = 'django-insecure-5hq5m61y*c4ny4+c%7-^o@0(mds+*7+$k$5e4(nxe$q9vspm0w'
...
WSGI_APPLICATION = 'AcademiSync.wsgi.application'
